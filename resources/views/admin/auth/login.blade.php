...
<div class="kt-login__signin">
    <form class="kt-form" action="{{url('admin/login')}}" method="post">
        ...
        <div class="input-group">
            <input class="form-control" type="text" placeholder="اسم الدخول" name="user_name" autocomplete="off">
        </div>
		<div class="input-group">
		...
		<div class="kt-login__actions">
			<button type="submit" class="btn btn-pill kt-login__btn-primary">الدخول</button>
		</div>
	</form>
</div>
